...
func buildProject(cfgFile string) {
	...
	if defaultLang == "cn" || p.Language == language.CN || p.Language == "cn" {
		...
		fmt.Println("- sqlite: " + ansi.Color("https://github.com/plumk97/go-admin/raw/master/data/admin.db", "blue"))
...
import "github.com/plumk97/go-admin/plugins/admin/modules/table"
