...
import (
	...
	"github.com/plumk97/go-admin/modules/collection"
	...
	errs "github.com/plumk97/go-admin/modules/errors"
	"github.com/plumk97/go-admin/modules/language"
	"github.com/plumk97/go-admin/modules/logger"
	"github.com/plumk97/go-admin/modules/ui"
	"github.com/plumk97/go-admin/modules/utils"
	"github.com/plumk97/go-admin/plugins/admin/models"
	form2 "github.com/plumk97/go-admin/plugins/admin/modules/form"
	"github.com/plumk97/go-admin/plugins/admin/modules/parameter"
	"github.com/plumk97/go-admin/plugins/admin/modules/tools"
	"github.com/plumk97/go-admin/template"
	"github.com/plumk97/go-admin/template/types"
	"github.com/plumk97/go-admin/template/types/action"
	"github.com/plumk97/go-admin/template/types/form"
	selection "github.com/plumk97/go-admin/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/plumk97/go-admin/modules/db/dialect", Value: "github.com/plumk97/go-admin/modules/db/dialect"},
			{Text: "github.com/plumk97/go-admin/modules/db", Value: "github.com/plumk97/go-admin/modules/db"},
			{Text: "github.com/plumk97/go-admin/modules/language", Value: "github.com/plumk97/go-admin/modules/language"},
			{Text: "github.com/plumk97/go-admin/modules/logger", Value: "github.com/plumk97/go-admin/modules/logger"},
		}).
		FieldDefault("").
